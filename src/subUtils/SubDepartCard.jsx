...
function SubDepartCard({ id, image, title, depart, buttonText, onClick, url }) {
  return (
    <div className="bg-[#F4F9FD] rounded-[22px] overflow-hidden flex flex-col items-center justify-center pt-6 pb-2">
      ...
      {/* Title and Button */}
      <h2 className="mb-1 text-[16px] leading-4 py-3 flex justify-center text-center font-nunito text-[#0A1629] dark:text-white h-[25px]">
        {title}
      </h2>
      <p className="mb-1 text-[16px] leading-4 py-1 flex justify-center text-center font-nunito text-[#0A1629] dark:text-white h-[20px]">
        {depart}
      </p>
